...
let meatprediction = () => {
  popUp.style.display = "flex";
  portMode = "meatprediction";
  popUpImg.src = "images/portfoliolargepics/meat_prediction1.png";

  popUpImg.innerHTML = `
      <a
        href="https://github.com/rpared/MeatProductionPrediction.git"
        target="_blank">
        <img src="images/portfoliolargepics/meat_prediction1.png">
      </a>
    `;
};
...
function nextSlide() {
  ...
  if (portMode == "meatprediction") {
    ...
    if (popUpImg.src.endsWith("meat_prediction2.png")) {
      popUpImg.src = "images/portfoliolargepics/meat_prediction1.png";
    } else if (popUpImg.src.endsWith("meat_prediction1.png")) {
      popUpImg.src = "images/portfoliolargepics/meat_prediction2.png";
    }
  }
  if (portMode == "rcb") {
